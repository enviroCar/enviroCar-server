...
public class TermsOfUseValidationTest {
    ...
    public void validateList() {
        assertThat(validate.parse(TERMS_OF_USE_LIST), is(validate.validInstanceOf(Schemas.TERMS_OF_USE)));
    }

    @Test
    public void validateInstance() {
        assertThat(validate.parse(TERMS_OF_USE), is(validate.validInstanceOf(Schemas.TERMS_OF_USE_INSTANCE)));
    }
}
